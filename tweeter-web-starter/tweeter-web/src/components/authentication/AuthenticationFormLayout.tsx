...
const AuthenticationFormLayout = (props: Props) => {
  const oauthProviders = [
    { name: "Google", icon: "google", key: 1 },
    { name: "Facebook", icon: "facebook", key: 2 },
    { name: "Twitter", icon: "twitter", key: 3 },
    { name: "LinkedIn", icon: "linkedin", key: 4 },
    { name: "GitHub", icon: "github", key: 5 },
  ];
